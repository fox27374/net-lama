...
const (
	ControlService_ControlStream_FullMethodName = "/netdata.ControlService/ControlStream"
)
...
func (c *controlServiceClient) ControlStream(ctx context.Context, opts ...grpc.CallOption) (grpc.BidiStreamingClient[ControlMessage, ControlMessage], error) {
...
type ControlService_ControlStreamClient = grpc.BidiStreamingClient[ControlMessage, ControlMessage]
...
func (UnimplementedControlServiceServer) ControlStream(grpc.BidiStreamingServer[ControlMessage, ControlMessage]) error {
...
func _ControlService_ControlStream_Handler(srv interface{}, stream grpc.ServerStream) error {
	return srv.(ControlServiceServer).ControlStream(&grpc.GenericServerStream[ControlMessage, ControlMessage]{ServerStream: stream})
}

// This type alias is provided for backwards compatibility with existing code that references the prior non-generic stream type by name.
type ControlService_ControlStreamServer = grpc.BidiStreamingServer[ControlMessage, ControlMessage]

// ControlService_ServiceDesc is the grpc.ServiceDesc for ControlService service.
// It's only intended for direct use with grpc.RegisterService,
// and not to be introspected or modified (even as a copy)
var ControlService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "netdata.ControlService",
